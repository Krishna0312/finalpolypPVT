...
if __name__ == '__main__':
    ...
    parser.add_argument('--pth_path', type=str, default=f'/content/drive/MyDrive/DC/pretrained_path/PolypPVT-best4.pth') #PolypPVT1.pth
    ...
    for _data_name in ['TestA', 'TestB', 'Val']:   #'CVC-300'
        ...
        ##### save_path #####
        save_path = '/content/drive/MyDrive/DC/result_map/PolypPVT-best4/{}/'.format(_data_name)
